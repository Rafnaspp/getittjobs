...
export const metadata: Metadata = {
  title: 'Retail Industry Recruitment | GETITT',
  description: 'Specialized recruitment solutions for retail and e-commerce. Find experienced retail professionals and management talent.',
  alternates: {
    canonical: 'https://getittjobs.com/industries/retail',
  },
}

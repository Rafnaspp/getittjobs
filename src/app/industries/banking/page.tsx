...
export const metadata: Metadata = {
  title: 'Banking & Finance Recruitment | GETITT',
  description: 'Expert recruitment solutions for banking and financial services. Connect with qualified finance professionals and banking experts.',
  alternates: {
    canonical: 'https://getittjobs.com/industries/banking',
  },
}

...
export const metadata: Metadata = {
  title: 'IT Recruitment | GETITT - Technology Staffing Solutions',
  description: 'Specialized IT recruitment services for tech companies. Find skilled developers, engineers, and IT professionals across India.',
  alternates: {
    canonical: 'https://getittjobs.com/industries/it',
  },
}

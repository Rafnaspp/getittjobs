import { HeartPulse, Brain, Stethoscope, Shield } from 'lucide-react'
import Link from 'next/link'
import type { Metadata } from 'next'

export const metadata: Metadata = {
  title: 'Healthcare Recruitment | GETITT - Medical Staffing',
  description: 'Healthcare recruitment specialists. Connect with qualified medical professionals, healthcare administrators, and support staff.',
  alternates: {
    canonical: 'https://getittjobs.com/industries/healthcare',
  },
}

...
export const metadata: Metadata = {
  title: 'Privacy Policy | GETITT',
  description: 'Read GETITT\'s privacy policy to understand how we protect your personal information and data privacy rights.',
  alternates: {
    canonical: 'https://getittjobs.com/privacy-policy',
  },
}

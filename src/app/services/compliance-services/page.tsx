...
export const metadata: Metadata = {
  title: 'Compliance Services | GETITT - HR Compliance Solutions',
  description: 'Ensure your recruitment processes meet all regulatory requirements with GETITT\'s comprehensive compliance services.',
  alternates: {
    canonical: 'https://getittjobs.com/services/compliance-services',
  },
}

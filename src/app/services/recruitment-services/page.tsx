...
export const metadata: Metadata = {
  title: 'Recruitment Services | GETITT - Expert Talent Acquisition',
  description: 'Transform your hiring process with GETITT\'s strategic recruitment services. Find top talent across industries efficiently.',
  alternates: {
    canonical: 'https://getittjobs.com/services/recruitment-services',
  },
}

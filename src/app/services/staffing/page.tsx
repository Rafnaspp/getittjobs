...
export const metadata: Metadata = {
  title: 'Staffing Services | GETITT - Professional Staffing Solutions',
  description: 'Get flexible and efficient staffing solutions from GETITT. We provide comprehensive workforce management services across industries.',
  alternates: {
    canonical: 'https://getittjobs.com/services/staffing',
  },
}
